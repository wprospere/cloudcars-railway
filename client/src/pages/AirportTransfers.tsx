        ...
        <div className="container max-w-6xl">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-14">
            <FeatureCard
              ...
              text="Plan your journey in advance with dependable collection times and professional service from door to terminal."
            />
            <FeatureCard
              title="Fixed Quoted Pricing"
              text="Clear, competitive pricing for popular airport routes from Nottingham and surrounding areas."
            />
            <FeatureCard
              title="Vehicle Options"
              text="Choose from standard, executive and larger vehicle options for individuals, families and groups."
            />
          </div>
              ...
              <table className="w-full border-collapse text-sm">
                <thead>
                  <tr className="border-b bg-secondary/50">
                    ...
                    <th className="p-4 text-left font-semibold">Larger Vehicle</th>
                  </tr>
                </thead>
