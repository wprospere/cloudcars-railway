          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <h3 className="font-semibold text-foreground mb-2">Editing Text Content</h3>
                  <p className="text-sm text-muted-foreground">
                    Go to "Edit Content" to update headings, descriptions, and other text 
                    on your website. Changes are saved automatically and appear on your 
                    website immediately.
                  </p>
                </div>
                <div>
                  <h3 className="font-semibold text-foreground mb-2">Managing Images</h3>
                  <p className="text-sm text-muted-foreground">
                    Use "Manage Images" to upload new images or replace existing ones. 
                    Supported formats include PNG, JPG, and WebP. Images are automatically 
